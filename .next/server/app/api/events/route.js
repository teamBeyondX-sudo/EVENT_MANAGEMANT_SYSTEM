...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/.pnpm/next@15.2.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_auth_middleware__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/auth/middleware */ \"(rsc)/./lib/auth/middleware.ts\");\n\n\nasync function GET(request) {\n    try {\n        const { searchParams } = new URL(request.url);\n        const category = searchParams.get('category');\n        const clubId = searchParams.get('clubId');\n        const allEvents = [\n            {\n                id: '1',\n                title: \"Tech Innovators Summit 2024\",\n                description: \"Join industry leaders and innovators for tech talks\",\n                date: \"2024-04-15\",\n                time: \"10:00 AM\",\n                location: \"Main Auditorium\",\n                category: \"Technology\",\n                isPaid: false\n            },\n            {\n                id: '2',\n                title: \"Cultural Fest 2024\",\n                description: \"Celebrate diverse cultural performances\",\n                date: \"2024-04-20\",\n                time: \"6:00 PM\",\n                location: \"Campus Ground\",\n                category: \"Cultural\",\n                isPaid: false\n            },\n            {\n                id: '3',\n                title: \"Career Fair Spring 2024\",\n                description: \"Meet top employers and explore opportunities\",\n                date: \"2024-04-25\",\n                time: \"9:00 AM\",\n                location: \"Convention Center\",\n                category: \"Career\",\n                isPaid: false\n            }\n        ];\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(allEvents);\n    } catch (error) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: 'Failed to fetch events'\n        }, {\n            status: 500\n        });\n    }\n}\nasync function POST(request) {\n    try {\n        const user = await (0,_lib_auth_middleware__WEBPACK_IMPORTED_MODULE_1__.authenticateUser)(request);\n        if (user.role !== 'admin') {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: 'Only admins can create events'\n            }, {\n                status: 403\n            });\n        }\n        const eventData = await request.json();\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(eventData);\n    } catch (error) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: 'Failed to create event'\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/events/route.ts\n");
...
var __webpack_exports__ = __webpack_require__.X(0, ["vendor-chunks/next@15.2.4_react-dom@19.1.0_react@19.1.0__react@19.1.0","vendor-chunks/semver@7.7.1","vendor-chunks/jsonwebtoken@9.0.2","vendor-chunks/jws@3.2.2","vendor-chunks/ecdsa-sig-formatter@1.0.11","vendor-chunks/safe-buffer@5.2.1","vendor-chunks/ms@2.1.3","vendor-chunks/lodash.once@4.1.1","vendor-chunks/lodash.isstring@4.0.1","vendor-chunks/lodash.isplainobject@4.0.6","vendor-chunks/lodash.isnumber@3.0.3","vendor-chunks/lodash.isinteger@4.0.4","vendor-chunks/lodash.isboolean@3.0.3","vendor-chunks/lodash.includes@4.3.0","vendor-chunks/jwa@1.4.1","vendor-chunks/buffer-equal-constant-time@1.0.1"], () => (__webpack_exec__("(rsc)/./node_modules/.pnpm/next@15.2.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fevents%2Froute&page=%2Fapi%2Fevents%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fevents%2Froute.ts&appDir=%2Fhome%2Frunner%2Fworkspace%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fhome%2Frunner%2Fworkspace&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!")));
